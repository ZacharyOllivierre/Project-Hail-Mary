...
vector<unique_ptr<Projectile>> Wand::attack(const Vector2 &origin, const Vector2 &direction)
{
    _origin = origin;
...
void Wand::make_bullets(vector<unique_ptr<Projectile>> &projectiles, const Vector2 &direction)
{
    ...
    for (int i = 0; i < count; i++)
    {
        ...
        Vector2 shot_direction = aim.rotated(angle);
