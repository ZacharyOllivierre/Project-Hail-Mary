...
void WandDebugData::render_debugger()
{
    ...
    ImGui::DragInt("Bullet Count", &_wand_attributes->bullet_count, 1.0f, 1, 128);
    ...
    ImGui::DragFloat("First Shot Delay", &_wand_attributes->first_shot_delay, 0.01f, 0.0f, 10.0f);
    ImGui::DragFloat("Shot Delay", &_wand_attributes->shot_delay_sec, 0.01f, 0.0f, 10.0f);
    ...
    ImGui::DragFloat("Acceleration", &_bullet_attributes->acceleration, 1.0f, 0.0f, 1000.0f);
    ...
    ImGui::DragFloat("Curve", &_bullet_attributes->curve, 0.1f, -360.0f, 360.0f);
    ImGui::DragInt("Bounces", &_bullet_attributes->bounces, 1.0f, 0, 32);
    ...
    ImGui::DragFloat("Growth", &_bullet_attributes->growth, 0.1f, 0.0f, 1000.0f);
}